function [correctedObservation,satPos_tTX,tTX] = removeErrorsDGPS(observation,navMessage,t,alpha,beta,initialEstimate)
...
for i = 1:size(observation,1)
    errIono(i) = ionosphereCorrection(x0,satPos_tTX(i,:),t,alpha,beta);
end
