function [Pk_prev,Xk_est,Xk_pred] = positionDataKF(flag,sigmaR,P_initial,measurement,x0,Pk_prev,Xk_prev)
...
if strcmp('initialize',flag) == 1
    ...
    R = sigmaR^2 * eye(3);          %Observation noise covariance matrix
